export const metadata = {
  ...
  description:
    "Контакты проката Action Rent в Санкт-Петербурге. Адрес, телефон, мессенджеры и карта проезда. Аренда сапбордов и туристического инвентаря без залога в СПб.",
};
