export const metadata = {
  ...
  description:
    "Прокат сапбордов, палаток и туристического снаряжения в Санкт-Петербурге. Прокат SUP-досок и палаток без залога. Все для активного отдыха — арендуй легко с Action Rent.",
};
