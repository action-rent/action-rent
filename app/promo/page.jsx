export const metadata = {
  ...
  description:
    "Актуальные акции и скидки на прокат SUP-досок, палаток и туристического снаряжения в Санкт-Петербурге. Выгодная аренда инвентаря без залога — только в Action Rent.",
};
