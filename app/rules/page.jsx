          ...
          <div className="rules-scrollbox">
            ...
            <div className="rule-block">
              ...
              <p>
                ...
                Возможен залог исключительно в денежной форме. Любой из залогов уточняйте по телефону!
              </p>
            </div>
            ...
            <div className="rule-block">
              ...
              <p>
                <strong>Срок аренды:</strong> Если вы берете до 18:00, то возврат до 12:00 следующего дня. <br />
                Если вы берете после 18:00, то возврат до 22:00 следующего дня.
              </p>
            </div>
            ...
            <div className="rule-block">
              ...
              <p>
                <strong>Состояние:</strong> возврат сухого и чистого снаряжения. За грязный инвентарь - компенсация.
              </p>
            </div>
